...
static volatile DetectedVectors Pixy2DetectedVectors;

I2c_DataType PixyReceivedLinesBuffer[2U];
...
I2c_RequestType PixyLinesReceive = {0x54, FALSE, FALSE, FALSE, FALSE, 50U, I2C_RECEIVE_DATA, PixyReceivedLinesBuffer};
